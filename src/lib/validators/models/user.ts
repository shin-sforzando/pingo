...
export const userSchema = z.object({
  // User ID, corresponds to the Firebase Auth UID (a string between 1-128 characters generated by Firebase).
  ...
  handle: z
    ...
    .max(24, { message: "Handle must be no more than 24 characters long." })
    .regex(/^[\p{L}\p{N}_]+$/u, {
      message:
        "Handle can only contain letters (including Japanese characters), numbers, and underscores.",
    }),
