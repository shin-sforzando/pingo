...
describe("subjects/check API", () => {
  ...
  it(
    "should validate subjects generated by the generate API in English",
    { retry: 2 }, // Retry up to 2 times due to Gemini API non-determinism
    async () => {
      // Skip this test if GEMINI_API_KEY is not available
      if (!process.env.GEMINI_API_KEY) {
        return;
  ...
  it(
    "should validate subjects generated by the generate API in Japanese",
    { retry: 2 }, // Retry up to 2 times due to Gemini API non-determinism
    async () => {
      // Skip this test if GEMINI_API_KEY is not available
      if (!process.env.GEMINI_API_KEY) {
